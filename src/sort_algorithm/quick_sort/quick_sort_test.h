...
class QuickSortTest {
 public:
	 static void TEST() {
		 std::cout << "----- QuickSortTest: -----" << std::endl;
		 ...
		 std::cout << "----- QuickSortTest over, access rate is " << 100.0 * access_no / case_no << "%. -----" << std::endl;
	 }
 ...
 private:
	 ...
	 static void judge(std::vector<int>& lhs, std::vector<int>& rhs) {
		 ads::quick_sort(lhs.begin(), lhs.end());
...
int QuickSortTest::case_no = 0;
int QuickSortTest::access_no = 0;

#endif // QUICK_SORT_TEST_H_
