 ...
 */
#ifndef INSERT_SORT_TEST_H_
#define INSERT_SORT_TEST_H_
#include<iostream>
#include<vector>
#include<list>
#include<algorithm>
...
class InsertSortTest {
 public:
	 static void TEST() {
		 std::cout << "----- InsertSortTest: -----" << std::endl;
		 ...
		 std::cout << "----- InsertSortTest over, access rate is " << 100.0 * access_no / case_no << "%. -----" << std::endl;
	 }
 ...
 private:
	 ...
	 static void judge(std::vector<int>& lhs, std::vector<int>& rhs) {
		 ads::insert_sort(lhs.begin(), lhs.end());
...
int InsertSortTest::case_no = 0;
int InsertSortTest::access_no = 0;

#endif // INSERT_SORT_TEST_H_
